package qjh.com.colorprogress.circleprogress;
...
import qjh.com.colorprogress.BuildConfig;
import qjh.com.colorprogress.R;
import qjh.com.colorprogress.circleprogress.utils.Constant;
import qjh.com.colorprogress.circleprogress.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        arcColors = typedArray.getColor(R.styleable.CircleProgressBar_arcColors, Color.YELLOW);
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(String.format(mPrecisionFormat, mValue) + "%", mCenterPoint.x, mValueOffset+10, mValuePaint);
