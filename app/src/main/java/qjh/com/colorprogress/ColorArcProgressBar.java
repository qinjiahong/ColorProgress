...
public class ColorArcProgressBar extends View {
    ...
    private float textSize = dp2px(16);
    private float hintSize = dp2px(14);
    private float curSpeedSize = dp2px(14);
    ...
    private int hintColor;//字体颜色
    private int contentColor;//进度颜色
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        color1 = a.getColor(R.styleable.ColorArcProgressBar_front_color1, Color.parseColor("#d82128"));
        color2 = a.getColor(R.styleable.ColorArcProgressBar_front_color2, Color.parseColor("#999999"));
        ...
        diameter = (int) a.getDimension(R.styleable.ColorArcProgressBar_arc_radius, dp2px(80));
        textSize = (int) a.getDimension(R.styleable.ColorArcProgressBar_font_size1, dp2px(14));
        hintSize = (int) a.getDimension(R.styleable.ColorArcProgressBar_font_size2, dp2px(14));
        contentColor = a.getColor(R.styleable.ColorArcProgressBar_contentColor, Color.parseColor("#d82128"));
        hintColor = a.getColor(R.styleable.ColorArcProgressBar_hintColor, Color.parseColor("#666666"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedContent) {
            canvas.drawText(String.format("%.0f", curValues) + "%", centerX, centerY + textSize / 3 + dp2px(5), vTextPaint);
        }
        if (isNeedUnit) {
            canvas.drawText(hintString, centerX, centerY + 2 * textSize / 3 + 30, hintPaint);
        }
        if (isNeedTitle) {
            canvas.drawText(titleString, centerX, centerY - 2 * textSize / 3 + dp2px(2), curSpeedPaint);
        }
